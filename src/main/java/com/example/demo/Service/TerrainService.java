...
public class TerrainService {
	...
	public Terrain Update (Terrain entity,int id) {
		Terrain terrain=terrainRepository.findById(id).get();
		terrain.setCategorie(entity.getCategorie());
		terrain.setMc(entity.getMc());
		terrain.setProprietaire(entity.getProprietaire());
	...
	public Iterable<Terrain> findByProprietaireCIN(String cin) {
		// Implement logic to fetch terrains based on proprietor CIN
		// Assuming a method findByProprietaireCIN in TerrainRepository
