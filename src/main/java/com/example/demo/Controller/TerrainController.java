...
public class TerrainController {
	...
	public Terrain Update(@RequestBody Terrain terrain,@PathVariable int id) {
		return terrainService.Update(terrain, id);
	}
	...
	public Iterable<Terrain> findByProprietaireCIN(@PathVariable String cin) {
		return terrainService.findByProprietaireCIN(cin);
	}
